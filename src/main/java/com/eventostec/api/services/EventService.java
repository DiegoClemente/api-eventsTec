...
public class EventService {
    ...
    public List<EventResponseDTO> getUpcomingEvents(int page, int size){
        ...
        return eventsPage.map(event -> new EventResponseDTO(event.getId(), event.getDescription(),
                        event.getDate(),
    ...
    public List<EventResponseDTO> getFilteredEvents(int page, int size, String title, String city, String uf, Date startDate, Date endDate){
        ...
        return eventsPage.map(event -> new EventResponseDTO(event.getId(), event.getDescription(), event.getDate(),
                        event.getAddress() != null ? event.getAddress().getCity() : "",
                        event.getAddress() != null ? event.getAddress().getUf() : "",
                        event.getRemote(), event.getEventUrl(), event.getImgUrl()))
                .stream().toList();
